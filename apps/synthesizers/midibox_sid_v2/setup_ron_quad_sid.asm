...
CS_MENU_DIN_TABLE
	...
	DIN_ENTRY	CS_MENU_BUTTON_Osc_Wav,  4,	 6
	DIN_ENTRY	CS_MENU_BUTTON_Osc_RS,   4,	 7
	...
	DIN_ENTRY	CS_MENU_BUTTON_Fil_Sel,	 7,	 6
	DIN_ENTRY	CS_MENU_BUTTON_Fil_Mod,  7,	 7

	DIN_ENTRY	CS_MENU_BUTTON_M_O1Ptch, 8,	 4
	DIN_ENTRY	CS_MENU_BUTTON_M_O2Ptch, 8,	 1
	DIN_ENTRY	CS_MENU_BUTTON_M_O3Ptch, 8,	 2
	DIN_ENTRY	CS_MENU_BUTTON_M_O1PW,   8,	 3
	DIN_ENTRY	CS_MENU_BUTTON_M_O2PW,   8,	 6
	DIN_ENTRY	CS_MENU_BUTTON_M_O3PW,   8,	 5
	DIN_ENTRY	CS_MENU_BUTTON_M_Filter, 8,	 0
	DIN_ENTRY	CS_MENU_BUTTON_M_E1,	 9,	 7
	DIN_ENTRY	CS_MENU_BUTTON_M_E2,	 9,	 0
	DIN_ENTRY	CS_MENU_BUTTON_M_L1,	 9,	 1
	DIN_ENTRY	CS_MENU_BUTTON_M_L2,	 9,	 2
	DIN_ENTRY	CS_MENU_BUTTON_M_L3,	 9,	 3
	DIN_ENTRY	CS_MENU_BUTTON_M_L4,	 9,	 4
	DIN_ENTRY	CS_MENU_BUTTON_M_L5,	 9,	 5
	DIN_ENTRY	CS_MENU_BUTTON_M_L6,	 9,	 6
...
;;      3 buttons to move to rotary
 	DIN_ENTRY	CS_MENU_BUTTON_M_Vol,	 8,	 7	; matrix: button below M_Filter
 	DIN_ENTRY	CS_MENU_BUTTON_Play,	 10,	 1	; direct access to play function
 	DIN_ENTRY	CS_MENU_BUTTON_SID_LR,	 10,	 2	; direct access to L/R toggling
;;	DIN_ENTRY	CS_MENU_BUTTON_SID_LR,	 9,	 7	; direct access to L/R toggling
	DIN_ENTRY	CS_MENU_BUTTON_M_Mode,	 2,	 7	; direct access to meter on/off function
	DIN_ENTRY	CS_MENU_BUTTON_Fil_ExtIn, 10,	 0	; direct access to Filter ExtIn Flag
	DIN_ENTRY	CS_MENU_BUTTON_Sync,	 0,	 0	; jumps to ENS->CLK menu
	DIN_ENTRY	CS_MENU_BUTTON_Arp,	 7,	 5	; enables/disables the arpeggiator of *all* oscillators
	DIN_ENTRY	CS_MENU_BUTTON_Knob,     7,      4	; changes to knob menu
...
CS_MENU_DOUT_TABLE
	...
	DOUT_ENTRY	TMP5, 5,				1,	7	; LFO positive LED
	...
	DOUT_ENTRY	TMP5, 6,				6,	5	; Play LED
	DOUT_ENTRY	TMP4, 6,				6,	6	; SID L LED
	DOUT_ENTRY	TMP4, 7,				6,	7	; SID R LED
	DOUT_ENTRY	TMP2, 2,				6,	3	; Mode Meter LED
	DOUT_ENTRY	TMP2, 3,				6,	4	; Mode Matrix LED
...
MIOS_ENC_PIN_TABLE
	...
	ENC_ENTRY  3,  0,  MIOS_ENC_MODE_DETENTED3	; Osc sustain/release/assign #4
	ENC_ENTRY  4,  0,  MIOS_ENC_MODE_DETENTED3	; Osc release/pulsewidth/assign #5

	ENC_ENTRY  3,  6,  MIOS_ENC_MODE_DETENTED3	; LFO rate
	ENC_ENTRY  5,  4,  MIOS_ENC_MODE_DETENTED3	; LFO depth

	ENC_ENTRY  7,  0,  MIOS_ENC_MODE_DETENTED3	; Filter CutOff
	ENC_ENTRY  6,  6,  MIOS_ENC_MODE_DETENTED3	; Filter Resonance

	ENC_ENTRY  5,  6,  MIOS_ENC_MODE_DETENTED3	; Env depth/assign #1
	ENC_ENTRY  5,  0,  MIOS_ENC_MODE_DETENTED3	; Env attack/assign #2
	ENC_ENTRY  6,  2,  MIOS_ENC_MODE_DETENTED3	; Env decay/assign #3
	ENC_ENTRY  6,  4,  MIOS_ENC_MODE_DETENTED3	; Env sustain/assign #4
	ENC_ENTRY  6,  0,  MIOS_ENC_MODE_DETENTED3	; Env release/assign #5
