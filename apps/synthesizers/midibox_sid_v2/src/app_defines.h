...
SID_ACTIVITY_FLAGS	EQU	0x05a	; SID value on midi note event
CS_SID_LED_BLINK_VALUE	EQU	0x05b	; SID LED blink value on midi note event
CS_SID_LED_FLAG		EQU	0x05c	; FLAG number in DOUT loop for SID LED blink
...
# error "DEFAULT_ENABLE_SWINSID && DEFAULT_ENABLE_FPGASID not allowed at the same time!"
#endif
...
SIDx_FPGASID_POTX	EQU	0x19
SIDx_FPGASID_POTY	EQU	0x1a

SIDx_FPGASID_DIGIFIX	EQU	0x1d
SIDx_FPGASID_STEREO_CFG	EQU	0x1e
SIDx_FPGASID_SID_CFG	EQU	0x1f
#endif
