...
#define DEFAULT_ENABLE_SWINSID 1
...
#define DEFAULT_ENABLE_UPPER_WAVEFORMS 1
...
CS_MENU_DIN_TABLE
	...
	DIN_ENTRY	CS_MENU_BUTTON_Exec,	 1,	 5
	DIN_ENTRY	CS_MENU_BUTTON_Sel1,	 1,	 0
	DIN_ENTRY	CS_MENU_BUTTON_Sel2,	 1,	 1
	DIN_ENTRY	CS_MENU_BUTTON_Sel3,	 1,	 2
	DIN_ENTRY	CS_MENU_BUTTON_Sel4,	 1,	 3
	DIN_ENTRY	CS_MENU_BUTTON_Sel5,	 1,	 4
	...
	DIN_ENTRY	CS_MENU_BUTTON_Shift,	 0,	 0	; was: link button
	DIN_ENTRY	CS_MENU_BUTTON_CC_PageUp, 0,     0	; combined CC/PageUp -- CC actived together with shift button (no error)
	DIN_ENTRY	CS_MENU_BUTTON_Edit_PageDown, 0, 0	; combined Edit/PageDown -- Edit actived together with shift button (no error)
	...
	DIN_ENTRY	CS_MENU_BUTTON_Osc_RS,   0,	 0
 	...
 	DIN_ENTRY	CS_MENU_BUTTON_LFO_Sel,	 2,	 5
	DIN_ENTRY	CS_MENU_BUTTON_LFO_Wav,	 2,	 4

	DIN_ENTRY	CS_MENU_BUTTON_Env_Sel,	 4,	 4
	DIN_ENTRY	CS_MENU_BUTTON_Env_Ctrl, 4,	 5

	DIN_ENTRY	CS_MENU_BUTTON_Fil_Sel,	 4,	 1
	DIN_ENTRY	CS_MENU_BUTTON_Fil_Mod,  4,	 0
	...
	DIN_ENTRY	CS_MENU_BUTTON_Play,	 0,	 0	; direct access to play function
	...
	DIN_ENTRY	CS_MENU_BUTTON_Arp,	 4,	 2	; enables/disables the arpeggiator of *all* oscillators
	DIN_ENTRY	CS_MENU_BUTTON_Knob,     4,      3	; changes to knob menu
...
MIOS_ENC_PIN_TABLE
	...
	ENC_ENTRY  2,  2,  MIOS_ENC_MODE_DETENTED3	; LFO depth

	ENC_ENTRY  4,  6,  MIOS_ENC_MODE_DETENTED3	; Filter CutOff
	ENC_ENTRY  3,  0,  MIOS_ENC_MODE_DETENTED3	; Filter Resonance

	ENC_ENTRY  2,  0,  MIOS_ENC_MODE_DETENTED3	; Env depth/assign #1
	ENC_ENTRY  2,  6,  MIOS_ENC_MODE_DETENTED3	; Env attack/assign #2
	ENC_ENTRY  3,  4,  MIOS_ENC_MODE_DETENTED3	; Env decay/assign #3
	ENC_ENTRY  3,  2,  MIOS_ENC_MODE_DETENTED3	; Env sustain/assign #4
	ENC_ENTRY  3,  6,  MIOS_ENC_MODE_DETENTED3	; Env release/assign #5
